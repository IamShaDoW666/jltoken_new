    ...
    <form class="tabs-wrap">
        <div class="tab" id="tab1content">
            <div class="form-group col-sm-8" :class="{'has-error' : errors['purchase_code']}">
                <a href="https://t.me/omscripts" target="_blank" style="float: right;">For more scripts contact Telegram @omscripts</a>
                <label for="puchase_code">
                    For more scripts contact Telegram @omscripts
                </label>
